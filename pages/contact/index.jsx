        ...
        <div className="flex flex-col w-full max-w-[700px]">
          ...
          >
            <div className="flex items-center justify-center gap-2">
              ...
              <a href="mailto:poorvanshnandwar01@gmail.com" className="hover:text-accent transition-colors">
                poorvanshnandwar01@gmail.com
              </a>
            </div>
            <div className="flex items-center justify-center gap-2">
              <BsPhone className="text-accent" />
              <a href="tel:+917770882857" className="hover:text-accent transition-colors">
                +91 7770882857
              </a>
            </div>
            <div className="flex items-center justify-center gap-2">
              <BsGeoAlt className="text-accent" />
